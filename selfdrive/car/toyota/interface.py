...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if ret.enableGasInterceptor:
      ...
      ret.longitudinalTuning.kpV = [.3, 0.2, 0.125] #smooth aceleration for brazilian corollah by AleSatoBrasilSP
      ret.longitudinalTuning.kiV = [0.09, 0.06] #smooth aceleration by AleSatoBrasilSP
    else:
      ret.gasMaxBP = [0.]
      ret.gasMaxV = [0.5]
      ret.longitudinalTuning.kpV = [.9, .6, .375] #smooth aceleration by AleSatoBrasilSP
      ret.longitudinalTuning.kiV = [0.27, 0.18] #smooth aceleration by AleSatoBrasilSP
